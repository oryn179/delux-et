  ...
  const socialLinks = [
    {
      ...
      label: t("contact.tiktok"), value: "@Delux_ET", href: "https://tiktok.com/@Delux_ET",
    },
    {
      icon: () => (
        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
      ...
      label: "Instagram", value: "@delux_et", href: "https://instagram.com/delux_et",
    },
  ];
      ...
      <main className="flex-1 gradient-hero py-12">
        <div className="container">
          ...
          <div className="text-center">
            <h2 className="text-xl font-semibold mb-6">{t("contact.followUs")}</h2>
            <div className="flex justify-center gap-6">
              {socialLinks.map((social) => (
                <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-card border border-border hover:border-primary transition-colors">
