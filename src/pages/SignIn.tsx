      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl p-6 md:p-8 shadow-elevated border border-border">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="bg-card px-2 text-muted-foreground">Or sign in with</span></div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <Button type="button" variant="outline" className="w-full gap-2" onClick={handleAppleLogin} disabled={isLoading}>
